## [1.7.0]
* add support for `event_classes` in upsertEvent [#123]
* Upgrade SDK dev env to PHP 8.1
* Update dependencies
...
[1.7.0]: https://github.com/cronofy/cronofy-php/releases/tag/v1.6.0
...
[#123]: https://github.com/cronofy/cronofy-php/pull/123
