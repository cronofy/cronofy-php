...
class ApplicationCalendarTest extends TestCase
{
    public function testCreateApplicationCalendar()
    {
        ...
        $http->expects($this->once())
            ...
            ->will($this->returnValue(array('{"token_type":"bearer","access_token":"fffff","expires_in":3600,"refresh_token":"2222","scope":"read_write","application_calendar_id":"my-unique-string","sub":"apc_567236000909002","linking_profile":{"provider_name":"cronofy","profile_id":"pro_n23kjnwrw2","profile_name":"n23kjnwrw2"}}', 200)));
